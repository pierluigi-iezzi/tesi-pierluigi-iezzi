...
const sfere = [
  ...
  {
    label: 'Uva',
    tooltip: 'L’esperienza, la passione e la cura di oltre 14.900 viticoltori al servizio del nostro bene più prezioso: l’uva che a ogni vendemmia viene conferita alle cantine sociali di riferimento, certificando l’appartenenza alla filiera tracciata ed integrata del Gruppo Caviro.',
  },
  {
    label: 'Vino',
  ...
  },
  {
    ...
    tooltip: 'Niente va perso durante la lavorazione del vino. Otteniamo e raccogliamo tonnellate di materia prima, come feccia, vinaccia e vinaccioli: quello che resta delle uve è pronto a trasformarsi in ingredienti e prodotti ad alto valore aggiunto.',
  },
  {
  ...
  },
  {
    ...
    tooltip: 'Il cuore della nostra ecosostenibilità. Il segreto dell’autosufficienza energetica. La reputazione e l’eccellenza che i partner ci riconoscono. Dobbiamo tutto questo agli scarti vegetali: raccogliamo sfalci, potature e sovvalli dal territorio, indispensabili per produrre energia elettrica e termica.',
  },
  {
    label: 'Bioenergia',
...
export default function EconomiaCircolare() {
  /* 
    selectedSfera serve a memorizzare l’indice da 0 a 7 della
    Sfera selezionata. Pause serve a mettere in pausa l’autoplay
    Del componente
  */
  ...
  /* Leggera rotazione da -45° a 0° allo scorrimento della pagina */
  const parallax = useParallax({ rotate: [-45, 0, 'easeOutQuad'] });

  useEffect(() => {
    if (!pause) {
      /*
        Se non in pausa, calcola la prossima sfera ricominciando
        Da 0 dopo la numero 7.
        Dopo 3 secondi cambia selectedSfera.
      */
    ...
    <div>
      ...
      <div className="row">
        <ul
          ...
          ref={parallax.ref} // passo il ref dell’effetto parallax impostato prima
        >
          {
          /*
            per ogni elemento dell’array sfere, genera un <li>. Key è una
            proprietà richiesta da react quando si generano elementi nel DOM
            in seguito ad un ciclo. onMouseOver seleziona la sfera e mette in
            pausa l’autoplay. onMouseOut fa ripartire l’autoplay.
            Se si tratta della selectedSfera, applica la classe sfera-zoommata
          */
